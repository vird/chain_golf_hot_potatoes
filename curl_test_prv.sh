#!/bin/bash
curl --data-binary '{"id":1,"jsonrpc":"2.0","method":"bc_height"}' -H 'content-type:text/plain;' http://localhost:10001
...
# fail
echo -n "FAIL " && curl --data-binary '{"id":1,"jsonrpc":"2.0","method":"get_balance","params":{"address":2}}' -H 'content-type:text/plain;' http://localhost:10001
...
curl --data-binary '{"id":1,"jsonrpc":"2.0","method":"get_tx_mining_mode","params":{}}' -H 'content-type:text/plain;' http://localhost:10001
curl --data-binary '{"id":1,"jsonrpc":"2.0","method":"set_tx_mining_mode","params":{"enabled": 1}}' -H 'content-type:text/plain;' http://localhost:10001
curl --data-binary '{"id":1,"jsonrpc":"2.0","method":"get_tx_mining_mode","params":{}}' -H 'content-type:text/plain;' http://localhost:10001
curl --data-binary '{"id":1,"jsonrpc":"2.0","method":"get_my_weight","params":{}}' -H 'content-type:text/plain;' http://localhost:10001
